...
def load_model(checkpoint_path):
    ...
    model = SRCNN.load_from_checkpoint(checkpoint_path)
    model.eval()
...
def main():
    parser = argparse.ArgumentParser(description='SRCNN Inference')
    parser.add_argument('--checkpoint', '-p', type=str, default='best_models/srcnn-epoch=16-val_ssim=0.9297.ckpt',
